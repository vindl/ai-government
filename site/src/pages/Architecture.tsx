...
export default function Architecture() {
  const { data, isLoading } = usePageContent("architecture");
  const { lang } = useLanguage();

  return (
    <ProseContent title={t(lang, "Architecture Decisions", "Arhitektura")}>
      {isLoading && (
