...
- [x] News Scout role prompt (`theseus/news-scout/CLAUDE.md`)
...
- [x] Research Scout agent (`theseus/research-scout/CLAUDE.md`) — tracks AI model releases, SDK updates, agent architecture patterns
